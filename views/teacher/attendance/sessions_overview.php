...
<thead><tr><th>Date</th><th>Session</th><th>Course</th><th>Status</th><th></th></tr></thead>
<tbody>
...
<td>
<a href="<?= APP_URL ?>/teacher/attendance/methods_list.php?session_id=<?= $s['id'] ?>" class="btn btn-sm btn-primary">Manage</a>
</td>
</tr>
<?php endforeach; ?>
</tbody>
