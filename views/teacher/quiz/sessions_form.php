...
<div class="admin-page-title">
    <div class="left">
        <h1><?= $quizId ? 'Sửa Quiz' : 'Tạo Quiz Mới' ?></h1>
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted d-block mt-2">Để trống nếu không giới hạn thời gian</small>
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg"></i> <?= $quizId ? 'Cập nhật' : 'Tạo' ?>
                        </button>
