...
<div class="admin-page-title">
  <div class="left">
    ...
    <p>Create a scheduled class session and assign course + teacher.</p>
  </div>
...
<div class="card" style="padding:16px;max-width:840px">
  ...
  <form method="post" action="<?= $formAction ?>">
    ...
    <div class="form-group">
      ...
      <input type="text" name="title" value="<?= htmlspecialchars($session['title']) ?>" placeholder="e.g. Lecture 04: Data Structures">
    </div>
    ...
    <div class="form-group">
      ...
      <textarea name="notes" placeholder="Optional notes for this session"><?= htmlspecialchars($session['notes']) ?></textarea>
    </div>
