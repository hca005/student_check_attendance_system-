...
<div class="users-page">
    <div class="page-heading">
        <div>
            ...
            <p class="page-sub">Create an admin, teacher, or student account in the users table.</p>
        </div>
    ...
    <form class="card user-form-card" method="post" action="<?= APP_URL ?>/index.php?page=admin_users_store">
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input class="plain-input <?= isset($errors['password']) ? 'is-invalid' : '' ?>" type="password" id="password" name="password" minlength="6" required>
            ...
            <div class="form-group">
                ...
                <select class="plain-input <?= isset($errors['is_active']) ? 'is-invalid' : '' ?>" id="is_active" name="is_active">
